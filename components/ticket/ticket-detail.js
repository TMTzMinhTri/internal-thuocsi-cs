import { Button, Drawer, FormControl, FormLabel, Grid, makeStyles, TextareaAutosize, TextField, Typography, Dialog } from '@material-ui/core';
...
export async function loadTicketDetail(ticketCode) {
    ...
    if (isValid(ticketRes)) {
        ...
        return {
            departments:
                departmentsRes?.data?.map((depart) => ({
                    ...depart,
                    value: depart.code,
                    label: depart.name,
                })) || [],
        ...
        >
            <div className={styles.grid}>
                {!!ticketDetail ? (
                                    ...
                                    <Grid container spacing={3} direction="row" justify="space-between" alignItems="center">
                                        <Grid item xs={12} sm={6} md={6}>
                                            <Typography gutterBottom>
                                                ...
                                                <FormLabel component="legend" style={{ color: 'black', marginBottom: '15px', fontSize: '32px' }}>
                                                ...
                                                <FormLabel component="legend" style={{ color: 'black', marginBottom: '15px', fontSize: '32px' }}>
                                                    Đơn hàng :{' '}
                                                    <b>
                                                        {ticketDetail?.orderId} - {ticketDetail?.orderCode}
                                                    </b>
                                                </FormLabel>
                                                <FormLabel component="legend" style={{ color: 'black', marginBottom: '15px' }}>
                                                    Giá trị đơn hàng:{' '}
                                                    <span style={{ color: 'green' }}>{formatNumber(ticketDetail?.totalPrice)} đ</span>
                                                </FormLabel>
                                                <FormLabel component="legend" style={{ color: 'black', marginBottom: '15px' }}>
                                                    Người tạo: <span style={{ color: 'grey' }}>{ticketDetail?.createdBy}</span>
                                                </FormLabel>
                                                <LabelFormCs>
                                                    Ngày mua: <span style={{ color: 'grey' }}>{formatDateTime(ticketDetail?.orderCreatedTime)}</span>
                                                </LabelFormCs>
                                            </Typography>
                                        </Grid>
                                        <Grid item xs={12} sm={6} md={6}>
                                        ...
                                        <Grid item xs={12} sm={6} md={3}>
                                            ...
                                            <MuiSingleAuto placeholder="Chọn" name="status" options={listStatus} errors={errors} control={control} />
                                        </Grid>
                                        <Grid item xs={12} sm={6} md={3}>
                                            <Typography gutterBottom>
                    ...
                    <div style={{ textAlign: 'center', padding: 60, fontSize: 24, color: '#555', background: '#fff', height: '90vh' }}>
                        Đang tải dữ liệu
                    </div>
                )}
            </div>
