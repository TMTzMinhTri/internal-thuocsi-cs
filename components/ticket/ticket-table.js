import { Chip, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tooltip, Grid } from '@material-ui/core';
                        ...
                        <TableBody>
                            {data.map((item) => (
                                <TableRow key={uuidv4()}>
                                    ...
                                    <TableCell align="left"> {moment(item.createdTime).locale('vi').fromNow()}</TableCell>
