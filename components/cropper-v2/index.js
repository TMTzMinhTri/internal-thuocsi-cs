 ...
 */
const ModalCropperV2 = ({ open, onClose, callback, title, text, myRef, maxfileSize = 1 }) => {
  ...
  return (
    <div>
      <Dialog open={open} scroll="body" className={styles.croperWidth} fullWidth>
        ...
        <DialogContent dividers>
          <label htmlFor="upload-photo" style={{ marginBottom: 5 }}>
            ...
            <Button color="secondary" variant="contained" component="span">
              <span>{image === '' ? 'Chọn ảnh' : 'Chọn ảnh khác'}</span>
            </Button>
          </label>
