...
const List = ({ anchor, row, listDepartment, resetData, toggleDrawer, idxPage }) => {
  const { register, handleSubmit, errors, control, setValue } = useForm({
    defaultValues: {
      ...
      departmentCode: {
        ...
        label: listDepartment.filter((department) => department.value === row.departmentCode)[0]
          .label,
      },
  ...
  useEffect(() => {
    (async () => {
      ...
      if (accountResp.status === 'OK') {
        setValue('assignUser', {
          value: accountResp.data[0].username,
          label: accountResp.data[0].username,
        });
      }
                ...
                >
                    ...
                    <Typography gutterBottom>
                      ...
                      >
                        ...
                        <span style={{ color: 'green' }}>
                          {formatNumber(orderData?.totalPrice)} đ
                        </span>
                      </FormLabel>
                      <FormLabel
                        component="legend"
                      ...
                      >
                        ...
                        <span style={{ color: 'grey' }}>
                          {formatDateTime(orderData?.createdTime)}
                        </span>
                      </FormLabel>
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    ...
                    <MuiSingleAuto
                      name="departmentCode"
                      onValueChange={(data) => {
                        updateListAssignUser(data?.code);
                      }}
